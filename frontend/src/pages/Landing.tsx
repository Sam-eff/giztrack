...
export default function Landing() {
  ...
  return (
    <>
      ...
      {/* Scoped inline styles — keeps everything self-contained */}
      <style>{`
      ...
      {/*
        CRITICAL: position:fixed + inset:0 + overflow-y:auto bypasses
        any parent overflow:hidden on html / #root that blocks scrolling.
      */}
      <div style={{
        position: "fixed",
        inset: 0,
        ...
        <nav style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <Link to="/login" style={{ fontWeight: 600, fontSize: 14, color: "var(--color-muted)", textDecoration: "none", padding: "8px 12px" }}>
                Sign in
              </Link>
        ...
        {/*  HERO                                                     */}
        {/* ======================================================== */}
        <section style={{ padding: "56px 16px 48px" }}>
          <div style={{ maxWidth: 680, marginInline: "auto", textAlign: "center" }}>
            ...
            <p style={{
              ...
              maxWidth: 480, marginInline: "auto", marginBottom: 32,
            }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
              <Link
                ...
                style={{
                  ...
                  padding: "14px 28px", borderRadius: 12, width: "100%", maxWidth: 280,
            ...
            <p style={{ fontSize: 12, color: "var(--color-muted)", fontWeight: 500, marginTop: 16 }}>
        ...
        <section style={{
          ...
          <div style={{ maxWidth: 1100, marginInline: "auto" }}>
            <div style={{ textAlign: "center", marginBottom: 40 }}>
              <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "clamp(1.4rem, 3.5vw, 2rem)", marginBottom: 10 }}>
                Everything your shop needs
              </h2>
              <p style={{ color: "var(--color-muted)", fontSize: 15, maxWidth: 440, marginInline: "auto", lineHeight: 1.6 }}>
                Replace spreadsheets, notebooks, and scattered WhatsApp threads with one unified system.
              </p>
            </div>
            ...
            <div style={{
              ...
              {features.map((f, i) => (
                ...
                >
                  ...
                  <h3 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 16, marginBottom: 6 }}>{f.title}</h3>
                  <p style={{ color: "var(--color-muted)", fontSize: 14, lineHeight: 1.6, margin: 0 }}>{f.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section style={{ padding: "56px 16px 56px" }}>
          <div style={{ maxWidth: 1100, marginInline: "auto" }}>
            <div style={{ textAlign: "center", marginBottom: 40 }}>
              ...
              <p style={{ color: "var(--color-muted)", fontSize: 15, maxWidth: 400, marginInline: "auto", lineHeight: 1.6 }}>
            ...
            <div style={{
              ...
              gap: 20, maxWidth: 680, marginInline: "auto",
            }}>
              ...
              <div style={{
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0, flex: 1, display: "flex", flexDirection: "column", gap: 12, marginBottom: 24 }}>
                  {freeFeatures.map((f, i) => (
                    <li key={i} style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 14, color: "var(--color-text)" }}>
                      <Check /> {f}
                    </li>
                  ))}
                </ul>
              ...
              <div style={{
                ...
                <p style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 17, marginBottom: 4, color: "var(--color-primary)" }}>Pro</p>
                <p style={{ fontSize: 13, color: "var(--color-muted)", marginBottom: 20 }}>For growing businesses.</p>
        ...
        <footer style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <img src="/favicon.png" alt="Giztrack" style={{ width: 20, height: 20, borderRadius: 6, opacity: 0.7 }} />
              <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 13, color: "var(--color-primary)" }}>Giztrack</span>
            </div>

            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 20, fontSize: 13, fontWeight: 500 }}>
